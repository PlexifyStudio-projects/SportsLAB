...
const dict = {
  ES: {
    ...
    results: {
      ...
      alt: (n, total) => `Captura de una apuesta de tenis ganada con SportsLAB (${n} de ${total})`,
    },
    lifestyle: {
      ...
      founderName: 'Abraham',
      founderRole: 'Fundador de SportsLAB',
      // Alt descriptivos: estas fotos son contenido, no decoración.
      founderAlt: 'Abraham, fundador de SportsLAB y analista de pronósticos de tenis',
      cap1Alt: 'Sesión de análisis nocturno de partidos de tenis del equipo de SportsLAB',
      cap2Alt: 'El fundador de SportsLAB de viaje, siguiendo el circuito de tenis',
      cap3Alt: 'El equipo de SportsLAB de noche, después de cerrar la jornada de análisis',
      cap4Alt: 'El fundador de SportsLAB al volante de su coche',
    ...
    a11y: {
      telegramFloat: 'Únete al canal de Telegram de SportsLAB',
      leagues: 'Torneos de tenis que cubrimos',
      stats: 'Estadísticas de SportsLAB',
  ...
  EN: {
    ...
    results: {
      ...
      alt: (n, total) => `Screenshot of a winning tennis bet with SportsLAB (${n} of ${total})`,
    },
    lifestyle: {
      eyebrow: 'Lifestyle',
      ...
      founderName: 'Abraham',
      founderRole: 'Founder of SportsLAB',
      founderAlt: 'Abraham, founder of SportsLAB and tennis betting analyst',
      cap1Alt: 'Late-night tennis match analysis session by the SportsLAB team',
      cap2Alt: 'The founder of SportsLAB travelling, following the tennis tour',
      cap3Alt: 'The SportsLAB team at night, after wrapping up the analysis',
      cap4Alt: 'The founder of SportsLAB behind the wheel of his car',
    ...
    a11y: {
      telegramFloat: 'Join the SportsLAB Telegram channel',
      leagues: 'Tennis tournaments we cover',
      stats: 'SportsLAB statistics',
